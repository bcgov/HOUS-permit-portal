...
ActiveRecord::Schema[7.2].define(version: 2026_02_12_180000) do
  ...
  create_table "overheating_documents",
               id: :uuid,
               default: -> { "gen_random_uuid()" },
               force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["overheating_tool_id"],
            name: "index_overheating_documents_on_overheating_tool_id"
    t.index ["scan_status"], name: "index_overheating_documents_on_scan_status"
  end

  create_table "overheating_tools",
               id: :uuid,
               default: -> { "gen_random_uuid()" },
               force: :cascade do |t|
    t.uuid "user_id", null: false
    ...
    t.string "rollup_status", default: "new_draft", null: false
    t.datetime "discarded_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["discarded_at"], name: "index_overheating_tools_on_discarded_at"
    t.index ["rollup_status"], name: "index_overheating_tools_on_rollup_status"
