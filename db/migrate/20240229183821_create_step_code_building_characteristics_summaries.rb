class CreateStepCodeBuildingCharacteristicsSummaries < ActiveRecord::Migration[7.1]
  def change
    create_table :step_code_building_characteristics_summaries, id: :uuid do |t|
      t.references :step_code_checklist, foreign_key: true, null: false, type: :uuid
      ...
      t.jsonb :windows_glazed_doors, default: { performance_type: :usi, lines: [{}] }
