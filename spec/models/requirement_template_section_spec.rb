...
RSpec.describe RequirementTemplateSection, type: :model do
  ...
  describe "associations" do
    ...
    it { should have_many(:template_section_blocks).dependent(:destroy).order(position: :asc) }
    it { should have_many(:requirement_blocks).through(:template_section_blocks) }
  end

  describe "#key" do
    it "returns the correct section key" do
      section = create(:requirement_template_section, requirement_template: requirement_template)
  ...
  describe "#to_form_json" do
    it "returns a hash representation of the section for form generation" do
      section = create(:requirement_template_section, requirement_template: requirement_template, name: "Test Section")
      ...
      tsb1 = create(:template_section_block, requirement_template_section: section, requirement_block: rb1)
      tsb2 = create(:template_section_block, requirement_template_section: section, requirement_block: rb2)
