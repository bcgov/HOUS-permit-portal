SIGNATURE_RESPONSE_STUB = [
  {
        ...
        "signerStatus" => {
          ...
          "certificateInfo" => {
            ...
            "issuer" => {
              ...
              "validity" => "VALID",
              "certificateInfo" => {
                "subjectName" => "C=CA,O=Notarius Inc,CN=Notarius Certificate Authority",
                "commonName" => "Notarius Certificate Authority",
                "issuer" => {
                  "trust" => "VALID",
                  "validity" => "VALID",
                  "certificateInfo" => {
                    "subjectName" => "C=CA,O=Notarius Inc,CN=Notarius Root Certificate Authority",
              ...
              "revocationInfo" => {
                ...
                "signatureResult" => {
                  ...
                  "signerStatus" => {
                    ...
                    "validity" => "VALID",
                    "certificateInfo" => {
                      "subjectName" => "CN=Notarius Root Certificate Authority, O=Notarius Inc, C=CA",
                      "commonName" => "Notarius Root Certificate Authority",
                    },
                    "result" => "SUCCESS",
                  },
    ...
    "signerStatus" => {
      ...
      "validity" => "VALID",
      "certificateInfo" => {
        "subjectName" => "C=CA,O=CertifiO Test - AATL,OU=Solutions Notarius,UID=h2test+CN=Test - H2 -- Notarius",
