...
RSpec.describe StepCode::Compliance::CheckRequirements::Energy::TEDIAdjusted do
  ...
  it "interpolates Zone 5 without Small Home at 210 m² (Rev. 7 >=210)" do
    # 40 + (50-40)*(3500-3000)/1000 = 45
    expect(call(hdd: 3500, heated_floor_area: 210)).to be_within(0.01).of(45)
  end

  it "uses HDDlowest 2500 and no Small Home in Zone 4" do
    # 30 + (40-30)*(2750-2500)/500 = 35
    expect(call(hdd: 2750, heated_floor_area: 180)).to be_within(0.01).of(35)
  end
