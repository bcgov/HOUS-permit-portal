...
if ENV["DOCKER_BUILDING"].blank? # skip this during precompilation in the docker build stage
  if Rails.env.production?
    ...
    redis_cfg = {
      ...
      sentinels: [{ host: ENV["REDIS_SENTINEL_HOST"], port: (ENV["REDIS_SENTINEL_PORT"] || 26_379) }],
      role: :master,
    }
