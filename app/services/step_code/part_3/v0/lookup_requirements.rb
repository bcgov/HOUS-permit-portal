class StepCode::Part3::V0::LookupRequirements
  ...
  def baseline_requirement
    StepCode::Part3::V0::Requirements::Baseline.new(checklist).call
  end

  def step_code_requirements
    StepCode::Part3::V0::Requirements::StepCode.new(checklist).call
  end

  def whole_building_requirements
    StepCode::Part3::V0::Requirements::WholeBuilding.new(checklist).call
  end
end
