class StepCode::Part3::V1::Performance::PerformanceRequirementAchieved < StepCode::Compliance::ProposeStep::Base
  attr_reader :performance_requirement, :performance_results, :requirements
