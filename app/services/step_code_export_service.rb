  ...
  def summary_csv
    CSV.generate(headers: true) do |csv|
      ...
      jurisdictions.each do |j|
        ...
        j.jurisdiction_step_requirements.each do |jsr|
          energy_step_required = jsr.energy_step_required
          zero_carbon_step_required = jsr.zero_carbon_step_required
          enabled =
            energy_step_required.present? || zero_carbon_step_required.present?
          csv << [
            jurisdiction_name,
            nil,
            enabled,
