module Part9StepCode
  class BuildingCharacteristicsSummary < ApplicationRecord
    ...
    serialize :doors_lines,
              coder: StepCode::BuildingCharacteristics::Line::Doors
    serialize :fossil_fuels,
              coder: StepCode::BuildingCharacteristics::FossilFuels
    ...
    serialize :other_lines,
              coder: StepCode::BuildingCharacteristics::Line::Other
    serialize :roof_ceilings_lines,
              coder: StepCode::BuildingCharacteristics::Line::RoofCeilings
    serialize :slabs_lines,
              coder: StepCode::BuildingCharacteristics::Line::Slabs
    serialize :space_heating_cooling_lines,
              coder:
                StepCode::BuildingCharacteristics::Line::SpaceHeatingCooling
