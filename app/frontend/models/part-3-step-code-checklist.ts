...
export const Part3StepCodeChecklistModel = types.snapshotProcessor(
  types
    .model("Part3StepCodeChecklistModel", {
      ...
      permitStage: types.maybeNull(types.string),
      buildingCodeVersion: types.maybeNull(types.string),
      // location details
