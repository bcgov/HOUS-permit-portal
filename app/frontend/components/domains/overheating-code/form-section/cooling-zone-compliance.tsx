    ...
    <Box>
      ...
      <VStack spacing={6} align="stretch">
        <SimpleGrid columns={{ base: 1, md: 2 }} spacing={6}>
          ...
          <FormControl>
            <FormLabel>{t("overheatingCode.sections.coolingZoneCompliance.unitsLabel", "Units")}</FormLabel>
            <Controller
              ...
              render={({ field }) => (
                <RadioGroup {...field}>
                  <Stack direction="row" spacing={6} pt={2}>
                    <Radio value={EOverheatingCodeCoolingZoneUnits.imperial}>
                      {t("overheatingCode.sections.coolingZoneCompliance.imperial", "Imperial")}
                    </Radio>
                    <Radio value={EOverheatingCodeCoolingZoneUnits.metric}>
        ...
        <FormControl isInvalid={!!errors.minimumCoolingCapacity}>
          ...
          <HStack maxW="400px">
            <InputGroup>
              ...
              />
              <InputRightAddon>{isMetric ? "kW" : "btuh"}</InputRightAddon>
            </InputGroup>
          </HStack>
