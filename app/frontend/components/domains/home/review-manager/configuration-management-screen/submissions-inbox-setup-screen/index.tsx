...
interface SubmissionsInboxSetupScreenProps {
  editPageUrl: string
}

export const SubmissionsInboxSetupScreen: React.FC<SubmissionsInboxSetupScreenProps> = observer(
  function SubmissionsInboxSetupScreen({ editPageUrl }) {
