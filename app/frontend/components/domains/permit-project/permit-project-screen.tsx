...
import { CaretLeft, ClipboardText, ClockCounterClockwise, Folder, SquaresFour } from "@phosphor-icons/react"
...
export const PermitProjectScreen = observer(() => {
  ...
  const TABS_DATA: ITabItem[] = [
    ...
    { label: t("permitProject.details.activity"), icon: ClockCounterClockwise, to: "activity", tabIndex: 2 },
