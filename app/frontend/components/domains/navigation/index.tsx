...
import { DocumentsTabPanelContent } from "../permit-project/documents-tab-panel-content"
  ...
  return (
    <>
      <Routes location={background || location}>
        ...
        <Route path="/part-9-step-code/:stepCodeId" element={<DocumentsTabPanelContent />} />
