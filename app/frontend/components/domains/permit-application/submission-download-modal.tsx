...
export interface ISubmissionDownloadModalProps extends ReturnType<typeof useDisclosure> {
  permitApplication: IPermitApplication
}

export const SubmissionDownloadModal = ({ isOpen, onOpen, onClose, permitApplication }) => {
