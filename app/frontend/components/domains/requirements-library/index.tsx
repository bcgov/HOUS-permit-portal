import { Box, Button, Grid, GridItem, GridItemProps, Heading, Text, VStack } from "@chakra-ui/react"
          ...
          {tableRequirementBlocks.map((requirementBlock) => {
            return (
              ...
              >
                ...
                <GridItem {...sharedGridItemsStyles}>{requirementBlock.name}</GridItem>
                <GridItem {...sharedGridItemsStyles}>{requirementBlock.name}</GridItem>
                <GridItem {...sharedGridItemsStyles}>{format(requirementBlock.updatedAt, "yyyy-MM-dd")}</GridItem>
