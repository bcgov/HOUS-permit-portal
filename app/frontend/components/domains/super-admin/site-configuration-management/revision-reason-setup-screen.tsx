import { Box, Button, Container, Divider, Flex, HStack, Heading, Input } from "@chakra-ui/react"
          ...
          <Flex mt={8} gap={16}>
            <Box minW="fit-content">
              <Heading as="h3" noOfLines={1}>
                {t("siteConfiguration.revisionReasonsAttributesSetup.settings")}
              </Heading>
            </Box>
                ...
                {R.isNil(activeRevisionReasons) ? (
                  ...
                  fields.map((field, index) => (
                    <Box
                      borderRadius="md"
                      border="1px solid"
                      borderColor={field._destroy ? "semantic.error" : "border.light"}
                      key={field.fieldId}
                    >
