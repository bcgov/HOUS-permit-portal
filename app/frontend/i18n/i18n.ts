...
[Optional: Your contact info, if needed for follow-up]`,
        ...
        sandbox: {
          ...
          live: "Live",
          liveDescription: "Permit templates currently available to the public",
          ...
          scopeDescriptions: {
            ...
            scheduled: "Upcoming permit templates available only in Training Mode for testing",
            deprecated: "",
            draft: "",
          },
          ...
          configurationManagement: {
            ...
            stepCodeRequirements: {
              ...
              part3Overview: {
                ...
                occupancyColumnHeader: "Occupancy",
                compliancePathwaysColumnHeader: "Compliance pathways",
                localOptionsColumnHeader: "Local options",
                pathwaysConfigured: "{{count}} pathways configured",
              ...
              part9Description:
                "Configure Energy and Zero Carbon Step Codes compliance requirements for Part 9 buildings",
              occupancyDetail: {
                stepLabel: "Step {{step}}",
                zeroCarbonELLabel: "EL-{{level}}",
                notApplicable: "Not applicable",
                stepRangeOnly: "Step {{step}} only",
                stepRangeFromTo: "Step {{from}} to Step {{to}}",
                zeroCarbonRangeOnly: "EL-{{level}} only",
                zeroCarbonRangeFromTo: "EL-{{from}} to EL-{{to}}",
                provincialBaseline: "Provincial baseline",
                provinceHasEstablished: "The Province has established the following minimum requirements:",
                energyStepCodeLabel: "Energy Step Code:",
                zeroCarbonStepCodeLabel: "Zero Carbon Step Code:",
                baselineDisclaimer:
                  "These requirements represent the minimum acceptable standard and cannot be changed.",
                applicableStepRanges: "Applicable Step ranges for this occupancy",
                notApplicableExplanation:
                  "Under the BC Building Code, higher Energy Step Code and Zero Carbon Step Code requirements are not applicable for this occupancy.",
                localCompliancePathways: "Local compliance pathways",
                pathwayDescription: "A project may comply by meeting any one of the pathways listed below",
                energyStepCodeLevel: "Energy Step Code Level",
                zeroCarbonStepCodeLevel: "Zero Carbon Step Code Level",
                cannotBeChanged: "Minimum Provincial requirements cannot be changed",
                energyStepCodeHeader: "Energy Step Code",
                zeroCarbonStepCodeHeader: "Zero Carbon Step Code",
                configurablePathwayDescription:
                  "A project may comply by meeting any one of the pathways listed below. Local compliance pathways override the provincial baseline.",
                addComplianceOption: "Add another compliance option",
                remove: "Remove",
                removePathway: "Remove pathway",
                cancel: "Cancel",
                save: "Save",
        ...
        externalApiKey: {
          ...
          fieldLabels: {
            ...
            sandbox: "Select permit template access",
          },
        ...
        site: {
          ...
          breadcrumb: {
            ...
            energyStep: "Step Code requirements",
            climateZones: "Climate zones and Heating Degree Days (HDD)",
            part3: "Part 3 (Large, complex buildings)",
            part9: "Part 9 (Small, simple buildings)",
            schoolsOtherThanColleges: "Schools other than colleges",
            libraries: "Libraries",
            colleges: "Colleges",
            recreationCentres: "Recreation centres",
            hospitals: "Hospitals",
            careCentres: "Care centres",
            hotelsAndMotels: "Hotels and motels",
            otherResidentialOccupancies: "Other residential occupancies",
            offices: "Offices",
            otherPersonalServices: "Other personal services",
            mercantileOccupancies: "Mercantile occupancies",
