...
[Optional: Your contact info, if needed for follow-up]`,
        ...
        submissionInbox: {
          ...
          reorder: "Reorder",
          daysInQueue_one: "{{count}} day in queue",
          daysInQueue_other: "{{count}} days in queue",
          ...
          projectColumns: {
            ...
            [EPermitProjectInboxSortFields.daysInQueue]: "Days in queue",
          ...
          applicationColumns: {
            ...
            [EPermitApplicationInboxSortFields.daysInQueue]: "Days in queue",
