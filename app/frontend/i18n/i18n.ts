        ...
        overheatingCode: {
          ...
          sections: {
            ...
            heating: {
              ...
              capacityLabel: "Minimum Heating Capacity",
              capacityHint: "Total building heat loss as per Clause 5.2.7",
              capacityInvalid: "Must be a positive number",
              unit: "btuh",
              complianceTitle: "Compliance Requirements",
              clause531:
            ...
            cooling: {
              ...
              nominalLabel: "Nominal Cooling Capacity",
              nominalHint: "Nominal Cooling Capacity as per Clause 6.3.1",
              minimumLabel: "Minimum Cooling Capacity",
              maximumLabel: "Maximum Cooling Capacity",
              capacityInvalid: "Must be a positive number",
              unit: "btuh",
              complianceTitle: "Compliance Requirements",
              clause632:
            ...
            compliance: {
              ...
              submittalTypeLabel: "Submittal is for",
              submittalTypeRequired: "Please select a submittal type",
              wholeHouse: "Whole House",
              roomByRoom: "Room by Room",
              unitsLabel: "Units",
              unitsRequired: "Please select a unit system",
              imperial: "Imperial",
              metric: "Metric",
            },
            calculationsBasedOn: {
              title: "Calculations Based On",
              description:
                "The assumptions and data the heat loss/gain calculation is based on. See following page for results.",
              dimensionalInfoLabel: "Dimensional Info Based On",
              dimensionalInfoPlaceholder: "e.g. Architect Design Dwgs Dated 21/Feb/2024",
              ...
              storiesLabel: "# of Stories",
              storiesInvalid: "Must be a positive number",
              hasBasementLabel: "Has Basement",
              weatherLocationLabel: "Weather Location",
              weatherLocationPlaceholder: "e.g. Vancouver",
              frontFacingLabel: "Front Facing",
              frontFacingOptions: {
                north: "North",
                northeast: "Northeast",
                east: "East",
              ...
              assumed: "Assumed?",
              airTightnessCategoryLabel: "Air Tightness",
              airTightnessOptions: {
                test: "Test (ACH50 & ELA10)",
                loose: "Loose (Pre 1945)",
                average: "Average (1946–1960)",
                present: "Present (1961–)",
                energy_tight: "Energy Tight",
              },
              ach50Label: "ACH50",
              ela10Label: "ELA10",
              windExposureLabel: "Wind Exposure, Site",
              windExposureOptions: {
                open_sea: "Open sea, fetch > 5 km",
                mud_flats: "Mud flats, no vegetation",
                open_flat_terrain: "Open flat terrain, grass",
                low_crops: "Low crops, x/H > 20",
                high_crops: "High crops, scattered obstacles",
                parkland: "Parkland, bushes, x/H ~ 10",
                suburban: "Suburban, forest",
                city_centre: "City centre",
              },
              windShelteringLabel: "Wind Sheltering, Building",
              windShelteringOptions: {
                none: "No local shielding",
                light: "Light local shielding",
                heavy: "Heavy",
                very_heavy: "Very heavy",
                complete: "Complete (by large buildings)",
              },
              internalShadingLabel: "Internal Shading",
              internalShadingOptions: {
                none: "No Shading",
                light_translucent: "Light-translucent shading",
                opaque_reflective: "Opaque Reflective shading",
              },
              occupantsLabel: "Occupants",
              occupantsInvalid: "Must be a positive number",
              ventilatedLabel: "Ventilated?",
              hrvErvLabel: "HRV/ERV?",
              aseLabel: "ASE %",
              atreLabel: "ATRE %",
              percentageInvalid: "Must be between 0 and 100",
              calculationUnitsLabel: "Units",
              calculationUnitsOptions: {
                imperial: "Imperial",
                metric: "Metric",
              },
            },
            heatingDesignConditions: {
              ...
              description: "Data used for winter (heating season) calculations.",
              invalidTemp: "Must be a valid number",
              outdoorTempLabel: "Outdoor Temp",
              indoorTempLabel: "Indoor Temp",
              meanSoilTempLabel: "Mean Soil Temp",
              soilConductivityLabel: "Soil Conductivity",
              soilConductivityOptions: {
                normal: "Normal (dry sand, loam, clay)",
                high: "High (moist soil, very wet soils or perma-frost)",
              },
              waterTableDepthLabel: "Water Table Depth",
              waterTableDepthOptions: {
                shallow: "Shallow (5–7 m)",
                normal: "Normal (7–10 m)",
                deep: "Deep (>10 m)",
              },
              slabFluidTempLabel: "Slab Fluid Temp",
              slabFluidTempPlaceholder: "Blank if not heated",
              slabFluidTempHint: "Leave blank if slab is not heated",
            },
            coolingDesignConditions: {
              title: "Cooling Design Conditions",
              description: "Data used for summer (cooling season) calculations.",
              invalidNumber: "Must be a valid number",
              outdoorTempLabel: "Outdoor Temp",
              indoorTempLabel: "Indoor Temp",
              rangeLabel: "Range",
              rangeHint: "Summer mean daily temperature range",
              latitudeLabel: "Latitude",
              latitudeHint: "Degrees north of the equator",
              latitudeRange: "Must be between 0 and 90",
            },
            buildingEnvelope: {
              ...
              placeholders: {
                aboveGradeWalls: 'e.g. 2x6 @ 24" cc w/R24 Batt & R10 Continuous, Drywall, Brick',
                belowGradeWalls: 'e.g. 8" Normal Concrete, R12 Insulation Blanket',
                floorsOnSoil: 'e.g. 4" Normal Concrete, R10 continuous below, No Thermal Break',
                ceilings: 'e.g. 2x4 Wood truss 24" cc w/R60 Blown Insulation, Drywall',
                exposedFloors: 'e.g. 2x8 @ 16" cc, R30 Batt, carpet floor',
                doors: 'e.g. 1-5/8" Steel polyurethane insulated',
                windows: "e.g. Dbl/low-E/argon/insul spacer/13mm/vinyl/SHGC 0.47",
                skylights: "e.g. South, 4/12, aluminum, double low-E/SHGC 0.47",
              },
            },
            roomByRoom: {
              title: "Calculation Results — Room by Room",
              description:
                "Enter heat loss and heat gain for each room. This section applies when the submittal type is Room by Room.",
              invalidNumber: "Must be a valid positive number",
              roomNameHeader: "Room Name",
              heatingHeader: "Heating (Btu/h)",
              coolingHeader: "Cooling (Btu/h)",
              roomNamePlaceholder: "e.g. Kitchen",
              roomNameRequired: "Room name is required",
              addRoom: "Add Room",
              removeRoom: "Remove room",
              summaryTitle: "Summary Values",
              ventilationLossLabel: "Ventilation Loss",
              ventilationLossHint: "If calculated separately from individual room losses",
              latentGainLabel: "Latent Gain",
              latentGainHint: "If calculated separately from individual room gains",
              totalsTitle: "Total Building Loss (5.2.7) & Nominal Cooling Capacity (6.3.1)",
