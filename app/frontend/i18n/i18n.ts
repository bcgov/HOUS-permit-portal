      ...
      translation: {
        ...
        overheatingCode: {
          ...
          sidebar: {
            ...
            coolingZoneCompliance: "Cooling Zone Compliance",
            designConditions: "Design Conditions",
            buildingComponents: "Building Components & Assemblies",
            attachedDocuments: "Attached Documents",
            calculationsPerformedBy: "Calculations Performed By",
            summary: "Summary",
          },
          sections: {
            introduction: {
              ...
              issuedToLabel: "These documents issued for the use of",
              issuedToRequired: "Please enter who these documents are issued for",
              issuedToPlaceholder: "e.g. Jane Smith, ABC Construction Ltd.",
              projectNumberLabel: "Project #",
              projectNumberRequired: "Please enter a project number",
              projectNumberPlaceholder: "e.g. 2026-001",
            },
            coolingZoneCompliance: {
              title: "Cooling Zone Compliance",
              description:
                "Specify the designated cooling zone rooms and minimum cooling capacity for code compliance.",
              designatedRoomsLabel: "Designated Room(s)",
              designatedRoomsPlaceholder: "e.g. Living Room, Kitchen, Bedroom 1",
              unitsLabel: "Units",
              imperial: "Imperial",
              metric: "Metric",
              minimumCoolingCapacityLabel: "Minimum Cooling Capacity",
              minimumCoolingCapacityHint: "Minimum Cooling Capacity as per F280-12 Sentence 6.3.1.",
              capacityInvalid: "Must be a valid positive number",
              capacityPlaceholder: "e.g. 26412",
              capacityUnit: "btuh",
            },
            designConditions: {
              title: "Design Conditions",
              description: "Design temperatures, ventilation, and zone parameters for the cooling assessment.",
              temperaturesHeading: "Temperatures",
              outdoorTempLabel: "Outdoor Temp",
              outdoorTempHint: "From BCBC Appendix C — July 2.5% dry bulb",
              indoorTempLabel: "Indoor Temp",
              indoorTempHint: "Fixed at 24°C per BC-SZCG clause 2.1.1",
              adjacentTempLabel: "Adjacent Temp",
              adjacentTempHint: "Auto-filled from outdoor temp per clause 2.1.3",
              invalidTemp: "Must be a valid temperature",
              tempRange: "Temperature must be between -80°C and 80°C",
              zoneAndVentilationHeading: "Zone & Ventilation",
              coolingZoneAreaLabel: "Cooling Zone Area",
              coolingZoneAreaHint: "Min. 48 ft² per occupant (bedrooms + 1)",
              areaInvalid: "Must be a valid positive number",
              areaMinimum: "Minimum 48 ft² per clause 2.2.4(2)",
              weatherLocationLabel: "Weather Location",
              weatherLocationPlaceholder: "e.g. Kaslo, BC",
              ventilationRateLabel: "Ventilation Rate",
              ventilationRateHint: "3.5 L/s per person (occupants = bedrooms + 1)",
              ventilationInvalid: "Must be a valid positive number",
              hrvErvHeading: "Heat/Energy Recovery",
              hrvErvLabel: "HRV/ERV?",
              hrvErvHint: "Is a Heat Recovery Ventilator or Energy Recovery Ventilator used?",
              atreLabel: "ATRE %",
              atreHint: "Adjusted Total Recovery Efficiency — zero if no HRV/ERV",
              invalidPercent: "Must be a valid number",
              percentRange: "Must be between 0% and 100%",
            },
            buildingComponents: {
              title: "Building Components & Assemblies",
              description:
              ...
              facingOutsideHeading: "Facing Outside",
              facingOutsideHint:
                "Walls, windows, doors, ceilings, and other assemblies that separate the cooling zone from the outdoors.",
              facingAdjacentHeading: "Facing Adjacent Spaces",
              facingAdjacentHint:
                "Walls, floors, ceilings, and other assemblies that separate the cooling zone from adjacent unconditioned spaces.",
              itemLabel: "Item {{label}}",
              itemPlaceholder: 'e.g. 2x6 @ 24" cc w/R24 Batt, Drywall, Brick',
              addItem: "Add Item",
            },
            attachedDocuments: {
              title: "Attached Documents & Notes",
              description: "List documents that accompany this report, along with any relevant notes.",
              lineLabel: "Line {{number}}:",
              linePlaceholder: "e.g. Plans, Window & Door Schedules, insulation details...",
              addLine: "Add Line",
            },
            calculationsPerformedBy: {
              title: "Calculations Performed By",
              description: "Provide contact information and attestation for the person who performed the calculations.",
              contactInfoHeading: "Contact Information",
              attestationHeading: "Attestation & Accreditation",
              attestationText:
                "I have reviewed and take responsibility for the design work described in this document & I am qualified in the appropriate categories.",
              fields: {
                name: "Name",
                company: "Company",
                address: "Address",
            ...
            summary: {
              title: "Summary",
              description:
                "Review your form completion status below and download the filled BC Single Zone Cooling report.",
              completionStatus: "{{completed}} of {{total}} sections complete",
              incompleteWarning:
            ...
            buildingLocation: {
              ...
              description: "Enter the address and location details for the building project.",
              modelLabel: "Model",
              modelPlaceholder: "e.g. Model A",
              siteLabel: "Site",
              sitePlaceholder: "e.g. Site 1",
              lotLabel: "Lot",
              lotPlaceholder: "e.g. Lot 12",
              postalCodeLabel: "Postal Code",
              postalCodePlaceholder: "e.g. V7L 1C3",
              postalCodeInvalid: "Must be a valid BC postal code",
            },
          },
        },
        contact: {
...
[Optional: Your contact info, if needed for follow-up]`,
        ...
        sandbox: {
          ...
          scheduledModeDescription: "Training mode (upcoming forms only)",
          publishedModeDescription: "Training mode (published forms only)",
          ...
          switch: {
            ...
            chooseWhichFormsToPreview: "Choose which forms to preview",
            publishedForms: "Published forms",
            publishedFormsDescription: "Preview and test forms that have already been published.",
            scheduledForms: "Scheduled forms",
        ...
        requirementsLibrary: {
          ...
          modals: {
            ...
            dataValidationSetup: {
              ...
              before: "On or before",
              after: "On or after",
              minSelectedCount: "Must check at least",
              maxSelectedCount: "Must check at most",
              thisNumber: "this number",
              thisDate: "this date",
              thisAmount: "this amount",
              limitAcceptedFileFormatsTo: "Limit accepted file formats to:",
        ...
        projectReadinessTools: {
          ...
          digitalSealValidator: {
            ...
            Validated: "Validated",
            notValidated: "There was a problem checking the seal on {{fileName}}",
            signedAt: "Signed at",
        ...
        site: {
          ...
          breadcrumb: {
            ...
            preCheck: "Pre-check",
            overheatingCodes: "Overheating Codes",
            projects: "Projects",
