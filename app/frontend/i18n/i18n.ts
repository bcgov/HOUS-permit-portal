...
[Optional: Your contact info, if needed for follow-up]`,
        ...
        singleZoneCoolingHeatingTool: {
          ...
          inactive: "Inactive",
          noneFoundExplanation:
            "There are currently no overheating protection compliance reports matching your search criteria",
          ...
          review: {
            ...
            roomByRoomIndex: "#",
            roomByRoomName: "Name",
            roomByRoomHeating: "Heating",
            roomByRoomCooling: "Cooling",
            buildingLocation: "Building location",
            compliance: "Compliance",
            heating: "Heating",
            cooling: "Cooling",
            calculationPerformedBy: "Calculation performed by",
            calculationBasedOn: "Calculation based on",
            climateData: "Climate data",
            heatingDesignConditions: "Heating design conditions",
            coolingDesignConditions: "Cooling design conditions",
          },
          ready: {
            title: "Your F280-12 compliance for overheating protection is ready",
            projectDetails: "Project details",
            projectNumber: "Project number",
            applicationNumber: "Application number",
            address: "Address",
            ...
            explore: "Explore interactive report",
            preferDownload: "Prefer results you can save and print?",
            downloadPdf: "Download the PDF report",
            whatNow: "What you can do now",
            subtitle: "Most reports are ready within a few minutes.",
          },
          result: {
            preparingTitle: "We're preparing your results",
            preparingSubtitle: "Most reports are ready within a few minutes.",
            whatHappensNext: "What happens next",
            stepAnalyze: "Your drawings are analyzed",
            stepGenerate: "A PDF report and interactive results are generated",
            stepAvailable: "The downloadable report and a link to interactive results are available in your Projects",
            noNeedToStay:
            ...
            failedSubtitle:
              "Something went wrong while generating your report. Please try again or contact support if the issue persists.",
          ...
          uploads: {
            ...
            storageTitle: "How we protect and store your file",
            storageDescription:
              "Our service partners use industry‑standard security to protect your files. Your files may be kept for a limited time, then deleted.",
            pdfFormatOnly: "PDF format only",
            oneFile: "One file, not multiple PDFs",
            dragAndDrop: "Drag and drop files here, or",
            browseDevice: "browse your device",
            drawingsMustBeLegibleAndProperlyScaled: "Architectural files must be legible and properly scaled",
          ...
          buildingLocation: {
            ...
            helpText: "Enter the building location details. (This is the location of the building on the site.)",
            model: "Model",
            site: "Site",
            lot: "Lot",
            plan: "Plan",
          ...
          coverSheet: {
            ...
            compliance: {
              title: "Compliance",
              helpText: "Select the compliance options.",
              submittalIsFor: "Submittal is for",
            ...
            calculationPerformedBy: {
              ...
              attestation: "I,",
              helpText:
                "have reviewed and take responsibility for the design work described in this document & I am qualified in the appropriate categories.",
              name: "Name",
              company: "Company",
              address: "Address",
              city: "City",
              ...
              email: "Email",
              fax: "Fax",
              designersSignature: "Designers signature, Stamp/imprint or other identification mark",
              reference1: "Accreditation reference 1",
              reference2: "Accreditation reference 2",
              date: "Issued Date & Purpose:",
              reissuedDate: "Re-issued Date & Purpose",
              signatureDate: "Signature Date",
              softwareInfo: "Software Information",
              next: "Continue",
              issuedForDate2: "Issued for (date):",
              issuedForDate: "Issued for (date):",
            },
          },
          inputSummary: {
            title: "CSA F280-12 input summary",
            next: "Continue",
            buildingLocation: {
            ...
            calculationBasedOn: {
              ...
              dimensionalInfo: "Dimensional info based on:",
              attachment: "Attachment",
              internalShading: "Internal shading",
              occupants: "Occupants",
              frontFacing: "Front facing",
              frontFacingAssumed: "Assumed?",
              frontFacingAssumedYes: "Yes",
              frontFacingAssumedNo: "No",
              airTightness: "Air tightness",
              airTightnessAssumed: "Assumed?",
              airTightnessYes: "Yes",
              airTightnessNo: "No",
              assumed: "Assumed?",
              yes: "Yes",
              no: "No",
              occupantsAssumed: "Assumed?",
              occupantsAssumedYes: "Yes",
              occupantsAssumedNo: "No",
              stories: "# of stories",
              weatherLocation: "Weather location",
            },
            climateData: {
              title: "Climate data",
              windExposure: "Wind exposure site",
              windSheilding: "Wind sheltering, building",
              ...
              hrvErv: "HRV/ERV?",
              atticTemp: "Attic temp",
              yes: "Yes",
              no: "No",
            },
            heatingDesignConditions: {
              title: "Heating design conditions",
              outdoorTemp: "Outdoor temp",
              outdoorTempUnits: "°C",
              indoorTemp: "Indoor temp",
              indoorTempUnits: "°C",
              soilConductivityUnits: "W/m·K",
              soilConductivity: "Soil conductivity",
              meanSoilTemp: "Mean soil temp",
              meanSoilTempUnits: "°C",
              waterTableDepth: "Water table depth",
              waterTableDepthUnits: "m",
              slabFluidTemp: "Slab fluid temp",
              slabFluidTempUnits: "°C",
            },
            coolingDesignConditions: {
              title: "Cooling design conditions",
              outdoorTemp: "Outdoor temp",
              range: "Range",
              rangeUnits: "°C",
              indoorTemp: "Indoor temp",
            ...
            inputSummarySections: {
              aboveGradeWalls: "Above-grade walls",
              belowGradeWalls: "Below-grade walls",
              ceilings: "Ceilings",
              floorsOnSoil: "Floors on soil",
              windows: "Windows",
              exposedFloors: "Exposed floors",
              doors: "Doors",
              skylights: "Skylights",
            },
            belowGradeWalls: {
          ...
          results: {
            title: "Room by room calculation results",
            buildingLocation: {
              helpText: "Enter the building location details.",
              model: "Model",
              site: "Site",
            ...
            calculationResults: {
              title: "Calculation results by room",
              roomName: "Room name",
              heating: "Heating (Btu/h)",
              cooling: "Cooling (Btu/h)",
            },
            totalBuildingLoss: "Total building loss",
          },
          pdfContent: {
            ventilationLoss: "Ventilation loss (if separate)",
            latentGain: "Latent gain (if separate, value or multiplier)",
            totalBuildingLoss: "Total building loss (5.2.7) & Nominal cooling capacity (6.3.1)",
            unitsHelpText: "Btu/h",
            title: "CSA STANDARD F280-12 COMPLIANCE",
            helpText:
              "NBC 2015: 9.33.5.1.; 9.36.3.2. & 9.36.5.15; NBC 2020; 9.33.5.1.; 9.36.3.2.; 9.36.5.15 (5); 9.36.8.9. (1); ",
            CSAF28012: "CSA F280-12",
            setVer: "Form Set Ver 24.10",
            form: "Form",
            theseDocumentsIssuedForTheUseOf: "These documents issued for the use of",
            andMayNotBeUsedByAnyOtherPersonsWithoutAuthorization:
              "and may not be used by any other persons without authorization. Documents for permit and/or construction are signed in red.",
            projectNumber: "Project #",
            buildingLocation: "Building Location",
            model: "Model",
            ...
            postalCode: "Postal code",
            compliance: "Compliance",
            seePage2ForInputSummaryAndPage3ForRoomByRoomValues:
              "(See page 2 for input summary and page 3 for room by room values)",
            submittalIsFor: "Submittal is for",
            wholeHouse: "Whole house",
            roomByRoom: "Room by Room",
            units: "Units",
            ...
            metric: "Metric",
            heating: "Heating",
            minimumHeatingCapacity: "Minimum heating capacity",
            unitsHelpText: "btuh",
            unitsHelpText2: "btuh",
            minimumCoolingCapacity: "Minimum cooling capacity",
            maximumCoolingCapacity: "Maximum cooling capacity",
            totalBuildingHeatLossAsPer527: "total building heat loss as per 5.2.7",
            heating531: "5.3.1",
            heating531HelpText:
            ...
            cooling: "Cooling",
            nominalCoolingCapacity: "Nominal cooling capacity",
            nominalCoolingCapacityAsPer631: "Nominal Cooling Capacity as per 6.3.1",
            cooling632: "6.3.2",
            cooling632HelpText:
            ...
            cooling633: "6.3.3",
            cooling633HelpText:
              "Where the cooling system is added to an existing heating system, it's capacity in Watts shall not exceed 18 times the capacity of the air-handling capacity of the existing system in L/s. (Cooling capacity in Tons not more than 1.0 per 400 CFM of air handling capacity)",
            cooling634: "6.3.4",
            cooling634HelpText:
            ...
            calculationsPerformedByName: "Name:",
            calculationsPerformedByCompany: "Company:",
            calculationsPerformedByCityAndProvince: "City & Province:",
            calculationsPerformedByAddress: "Address:",
            calculationsPerformedByPostalCode: "Postal Code:",
            calculationsPerformedByPhone: "Phone:",
            calculationsPerformedByFax: "Fax:",
            calculationsPerformedByEmail: "Email:",
            designersSignatureStampDigitalOrOtherCertificationMark:
              "Designers Signature - Stamp Digital or other Certification Mark",
            attestation: "I,",
            attestationHelpText:
              "have reviewed and take responsibility for the design work described in this document & I am qualified in the appropriate categories.",
            accreditation: "Accreditation",
            accreditationReference1: "Reference 1:",
            accreditationReference2: "Reference 2:",
            issuedForDate: "Issued for (date):",
            issuedForDate2: "Issued for (date):",
            page: "Page: 1 of",
            areaForSoftwareVendorsInformationLogoContactInfoVersionNumber:
              "Area for Software vendors information, logo, contact info, version number etc",
            F280FormsSet2410xlsxCover: "F280-FormsSet24.10.xlsxCover",
            reissuedDateAndPurpose: "Re-issued Date & Purpose",
            signatureDate: "Signature Date",
            softwareInfo: "Software Information",
            next: "Next",
            inputSummary: {
              ...
              calculationBasedOn: {
                ...
                page2Of: "Page: 2 of",
                soilConductivity: "Soil Conductivity",
                SeeFollowingPageForResults: "See Following Page For Results",
                dimensionalInfo: "Dimensional Info",
                basedOn: "Based On",
                attachment: "Attachment",
                frontFacing: "Front Facing",
                frontFacingAssumed: "Assumed?",
                ...
                airTightnessNo: "No",
                weatherLocation: "Weather Location",
                internal: "Internal Shading",
                windExposureSite: "Wind Exposure, Site",
                occupants: "Occupants",
                windShelteringBuilding: "Wind Sheltering, Building",
                ventilated: "Ventilated?",
                hrvErv: "HRV/ERV?",
                atticTemp: "Attic Temp",
                yes: "Yes",
            ...
            issued: "Issued:",
            page2Of: "Page: 2 of",
            F280FormsSet2410xlsxSummary: "F280-FormsSet24.10.xlsxSummary",
            roomByRoomCalculationResults: {
              title: "ROOM by ROOM CALCULATION RESULTS",
              CSAF28012: "CSA F280-12",
              Form: "Form",
              SetVer2410: "Set Ver 24.10",
              ...
              province: "Province",
              postalCode: "Postal code",
              calculationResultsRoomByRoom: "Calculation - room by room",
              roomName: "Room Name",
              heating: "Heating (Btu/h)",
              cooling: "Cooling (Btu/h)",
              ventilationLoss: "Ventilation Loss (if separate) & Latent Gain (if separate, value or multiplier)",
              BtuPerH: "Btu/h",
              totalBuildingLoss: "Total Building Loss (5.2.7) & Nominal Cooling Capacity (6.3.1.)",
              seePage1ForHeatingAndCoolingSystemCapacityLimits:
                "(See page 1 for heating & cooling system capacity limits)",
              issued: "Issued:",
              page3Of: "Page: 3 of",
              F280FormsSet2410xlsxResults: "F280-FormsSet24.10.xlsxResults",
              areaForSoftwareVendorsInformationLogoContactInfoVersionNumber:
                "Area for Software vendors information, logo, contact info, version number etc",
            },
          },
