...
[Optional: Your contact info, if needed for follow-up]`,
        ...
        infoDocuments: {
          index: {
            ...
            documentList: "Guides and fact sheets",
            emptyTitle: "No guides or fact sheets yet",
            emptyBody:
              "Guides and fact sheets will appear here once they are published. Check back soon, or contact us if you are looking for something specific.",
        ...
        site: {
          ...
          navMenu: {
            ...
            about: {
              ...
              infoDocuments: {
                label: "Guides and fact sheets",
                description: "Short guides and one-page summaries about Building Permit Hub",
              },
