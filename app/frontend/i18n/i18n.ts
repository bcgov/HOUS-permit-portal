    ...
    en: {
      translation: {
        ...
        qaTools: {
          ...
          title: "QA tools",
          description:
            "Shown when QA mode is enabled in this environment. Shortcuts to seed a full permit project, autofill an application, or autofill Part 3 or Part 9 Step Codes for testing.",
          ...
          autofillPart9StepCode: "Autofill Part 9 Step Code",
          autofillPart9Success: "Part 9 Step Code autofilled",
        },
        landing: {
        ...
        preCheck: {
          ...
          infoPage: {
            title: "Pre-check your drawings for compliance with the BC Building Code",
            description:
        ...
        overheatingCode: {
          ...
          form: {
            ...
            backToOverheatingCodes: "Go to overheating",
          },
          index: {
            title: "Overheating",
            intro:
        ...
        jurisdiction: {
          ...
          edit: {
            ...
            stepCode: {
              ...
              zeroCarbonStepRequired: "Zero Carbon Step Code required",
          ...
          resources: {
            ...
            categories: {
              ...
              project_meeting_authorization: "Project meeting authorization",
            },
          },
          documents: {
            title: "Documents",
          ...
          aboutSnippets: {
            ...
            keyStagesTitle: "Key Stages",
            officeAddressTitle: "Office Address",
            placeholder: "Enter text",
            emptyHint: "Click Edit to add text",
            maxLengthTwoLines: "Use at most {{max}} characters (about two lines).",
            maxLengthOffice: "Office address is too long.",
          },
          contactInfoBanner: {
            ...
            email: "Email",
            emptyHint: "—",
            maxLengthHours: "Office hours text is too long.",
            maxLengthTelephone: "Telephone number is too long.",
            maxLengthEmail: "Email is too long.",
          },
...
[Optional: Your contact info, if needed for follow-up]`,
        ...
        permitCollaboration: {
          ...
          popover: {
            ...
            assignment: {
              ...
              additionalCollaborators: "Additional collaborators",
          ...
          projectSidebar: {
            ...
            selectApplication: "Select permit application",
            designatedReviewer: "Reviewer",
            goToApplication: "Go to the application to manage block-level collaborator assignments.",
          },
        },
        submissionInbox: {
          workspace: "Workspace",
          ...
          setupEmailNotificationsLink: "Submissions setup",
          ...
          list: "List",
          columns: "Columns",
          columnsViewComingSoon: "Columns view coming soon",
          changeStatus: "Change status",
          changeState: "Change state",
          showColumn: "Show",
          hideColumn: "Hide",
          noFilteredResultsWithStatus: "No filtered results with this status",
          noFilteredResultsWithState: "No filtered results with this state",
          unreadCount: "{{count}} unread",
          markUnread: "Mark as unread",
          reorder: "Reorder",
          dragToReorder: "Drag to reorder",
          moveToTop: "To the top",
          moveUp: "Up",
          moveDown: "Down",
          moveToBottom: "To the bottom",
          daysInQueue_one: "{{count}} day with us",
          daysInQueue_other: "{{count}} days with us",
          waitingSince: "Waiting since",
          daysWithUsTooltip: "Business days this application has been with our team and waiting for action",
          applicationsReceived: "{{received}} of {{total}} received",
          activeProjectMeeting: "Active meeting request",
          permitApplicationStatuses: "Permit application statuses",
          applicationsViewComingSoon: "Applications view coming soon",
          ...
          projectDetail: {
            ...
            recentPermitApplications: "Recent permit applications",
            noRecentPermitApplications: "No recent permit applications for this project.",
            viewAllPermits: "View all applications",
            permitApplications: "Permit applications",
            noApplications: "No applications",
            notesInfoTitle: "Notes for this project appear here",
            notesInfoDescription:
              "Meeting notes and messages sent with a revision are visible to the applicant and the review team.",
            projectMeetingNotes: "Project notes",
            notesEmptyDescription: "Meeting notes and sent revision messages will appear here.",
            viewProjectMeeting: "View project meeting",
            meetingNote: "On meeting",
            noteToApplicant: "on revision requests",
            messageFromSubmitter: "on submittal",
            applicationCount_one: "{{count}} application",
            applicationCount_other: "{{count}} applications",
            showingResultSummary: "Showing {{count}} {{label}}",
            showingResultSummaryFiltered: "Showing {{filtered}} of {{total}} {{label}}",
          },
          ...
          filters: {
            ...
            daysInQueue: "Days with us",
            daysInQueueGte: "Greater than or equal to",
            daysInQueueLt: "Less than",
            daysInQueueDays: "days",
            assigned: "Assigned",
            all: "All",
            hide: "Hide",
            onlyShow: "Only show",
            meetingDate: "Meeting date",
            meetingDatesBetween: "Meeting dates between",
            meetingDateFrom: "From",
            meetingDateTo: "To",
            next7Days: "Next 7 days",
            next30Days: "Next 30 days",
          },
          projectStates: {
            [EProjectState.draft]: "Draft",
            [EProjectState.queued]: "Queued",
            [EProjectState.waiting]: "Waiting",
            [EProjectState.inProgress]: "In Progress",
            [EProjectState.ready]: "Ready",
            [EProjectState.permitIssued]: "Permit Issued",
            [EProjectState.active]: "Active",
            [EProjectState.complete]: "Complete",
            [EProjectState.closed]: "Closed",
          },
          projectColumns: {
            [EPermitProjectInboxSortFields.projectNumber]: "Project number",
            [EPermitProjectInboxSortFields.address]: "Address",
            [EPermitProjectInboxSortFields.applications]: "Applications",
            [EPermitProjectInboxSortFields.daysInQueue]: "Days with us",
            [EPermitProjectInboxSortFields.assigned]: "Assigned",
            [EPermitProjectInboxSortFields.state]: "State",
          },
          applicationColumns: {
            [EPermitApplicationInboxSortFields.status]: "Status",
            [EPermitApplicationInboxSortFields.permitType]: "Permit type",
            [EPermitApplicationInboxSortFields.address]: "Address",
          ...
          seeMore: "See more?",
          showMoreInColumn: "+{{count}} more — view in list",
        },
        permitProject: {
          searchPlaceholder: "Search by project number, address, PID, or submitter",
          ...
          overview: {
            ...
            firstApplicationReceived: "First application received",
            ...
            recentPermits: "Recent applications",
            permit: "Application",
            applicationNickname: "Custom name",
            assignedTo: "Assignee",
            createdBy: "Created by",
            permitApplicationNumber: "HUB #",
          ...
          transition: {
            success: "Project state updated successfully",
            error: "This state transition is not allowed",
            confirmTitle: "Change project state",
            confirmMessage: "Are you sure you want to change this project's state?",
          },
          addPermits: {
            title: "Add applications to the project",
          ...
          meetings: {
            requestButton: "Request project meeting",
            requestWithJurisdiction: "Request a project meeting with {{jurisdictionName}}",
            requestedTitle: "Project meeting requested",
          ...
          notes: {
            infoTitle: "Notes for this project appear here",
            infoDescription:
              "Meeting notes and messages sent with a revision are visible to the applicant and the review team.",
          ...
          applicationsSummary: {
            empty: "No applications started yet",
            readyToWork: "{{ready}} of {{total}} permit(s) are ready to be worked on",
          },
        ...
        projectMeeting: {
          ...
          projectDescriptionHint:
            'Describe the work being proposed. For example: "New two-storey laneway house with detached garage."',
          meetingNotes: "Notes for the meeting (optional)",
          meetingNotesHint:
            "Share any questions, concerns, or context that may help the jurisdiction prepare for your meeting.",
          fileName: "File name",
          ...
          detail: {
            ...
            withdrawConfirmationBody:
              "Withdrawing will mark this meeting request as withdrawn. The local authority will not use this request to schedule a meeting about your project.",
            confirmWithdrawMeeting: "Yes, withdraw request",
            keepMeetingRequestOpen: "No, keep request open",
            withdrawError: "We couldn't withdraw your meeting request. Please try again.",
            sentOn: "Sent {{date}}",
            statusBanner: {
              draft: {
              ...
              withdrawn: {
                title: "Meeting request withdrawn",
                description: "This meeting request has been withdrawn and is no longer active.",
              },
            },
            ...
            downloadCalendarInvite: "Download invite",
            downloadCalendarError: "We couldn't download the calendar invite. Please try again.",
            projectNumber: "Project number",
            ...
            notes: {
              ...
              emptyDescription: "Add notes to track communication and coordination.",
              projectMeetingNoteLabel: "Project meeting note",
              visibleToRequesterAndCollaborators: "Visible to meeting requester and project collaborators.",
            },
            reviewer: {
              ...
              scheduleDescription:
                "You must contact the requester directly to arrange a meeting time. After a meeting is scheduled, you can add the date, time, and meeting details here.",
              rescheduleTitle: "Change meeting details",
              rescheduleDescription:
                "Update the date, time, or contact method. The requester and meeting contacts will be notified of the change.",
              contactMethod: "Contact method",
              contactMethodSummary: "Contact method:",
              meetingLink: "Link for the requester to join",
              meetingDate: "Meeting date",
              meetingTime: "Meeting time",
              clearScheduleForm: "Clear",
              resetMeetingDetailsForm: "Reset",
              cancelEditMeetingDetails: "Cancel",
              sendMeetingDetails: "Send meeting details",
              sendUpdatedMeetingDetails: "Send updated meeting details",
              scheduleError: "We couldn't schedule this meeting. Please review the meeting details and try again.",
              rescheduleSuccess: "Meeting details updated and notifications sent.",
              rescheduleError: "We couldn't update this meeting. Please review the meeting details and try again.",
              contactMethodRequired: "Select a contact method.",
              meetingLinkRequired: "Enter a meeting link.",
              meetingDateRequired: "Select a meeting date.",
              meetingTimeRequired: "Enter a meeting time.",
              scheduledTitle: "Meeting scheduled",
              scheduledDescription: "The requester has been contacted and a meeting has been scheduled.",
              dateAndTime: "Date and time:",
              copyMeetingLink: "Copy meeting link",
              joinMeeting: "Join meeting",
              changeMeetingDetails: "Change meeting details",
              withdrawMeeting: "Withdraw meeting",
              withdrawConfirmationTitle: "Withdraw this meeting request?",
              withdrawConfirmationBody:
                "Withdrawing will mark this meeting request as withdrawn. The requester will no longer see it as an active meeting request.",
              confirmWithdrawMeeting: "Yes, withdraw request",
              withdrawError: "We couldn't withdraw this meeting request. Please try again.",
          ...
          contactMethods: {
            phone: "Jurisdiction will call the requester",
          ...
          validation: {
            ...
            featureUnavailable: "Project meeting requests are not available for this project.",
            projectDescriptionRequired: "Enter a project description.",
            propertyInformationRequired: "Select yes or no.",
            relationshipRequired: "Select your relationship to this site.",
            saveError: "We couldn't save your meeting request. Please try again.",
            submitError: "We couldn't send your meeting request. Please review your responses and try again.",
          },
          relationships: {
            owner_or_landholder: "Owner or landholder",
            leaseholder_or_tenant: "Leaseholder or tenant",
            owners_representative: "Owner's representative (agent)",
            other: "Other",
          },
          sections: {
            projectInformation: {
            ...
            propertyInformation: {
              ...
              description:
                "Some building authorities can share existing property information to help you prepare for a project meeting, such as past permits or drawings. If you request this information, they will contact you separately. Availability and fees vary by community.",
            },
            review: {
              title: "Check your responses before sending your request",
            },
          },
          sent: {
            title: "Project meeting request sent",
            description: "Your request has been sent to the local authority. They will contact you to book a meeting.",
            whatHappensNext: "What happens next",
            ...
            next3: "If you requested property information, they will follow up with you separately",
            next4: "While your request is under review, the authority may add notes or updates to your project",
            next5: "You'll receive notifications when there are updates to your project",
            next6: "You can check your project status and view notes at any time from your project overview",
            returnToProject: "Return to project",
          },
        },
        document: {
        ...
        permitApplication: {
          ...
          submissionInbox: {
            contactInviteWarning:
              "Please have a Review Manager setup the Submissions in Configuration Management to allow submissions to be received.",
            title: "Submissions",
          ...
          show: {
            wasSubmitted: "Application was first submitted on {{ date }} to {{ jurisdictionName }}",
            submittingTo: {
            ...
            downloadApplicationNumber: "Application number: {{number}}",
            ...
            downloadVersionNotice: "Showing files from the submission on {{date}}.",
            downloadViewLatest: "View the latest submission",
            generating: "Generating...",
            errorPreparingHeading: "Error preparing files",
            errorPreparingTitle: "We couldn’t prepare your files for download",
            errorPreparingBody:
              "Try again later or email digital.codes.permits@gov.bc.ca for support if the issue continues.",
            downloadJson: "Download the application as JSON",
            readyForReview: "Ready for review",
            startingReview: "Starting review...",
            addingRequests: "Adding requests",
            ...
            revision: {
              newRevision: "Current submission",
              pastRequests: "Past submissions",
              pastSubmissionsEmpty: "No past submissions yet.",
              reason: "Reason",
              reasonCode: "Reason code",
              revisionRequest: "Revision request",
              goToField: "Go to field",
              viewRequest: "View request",
              fieldChanged: "This field has changed",
              filesUploaded: "Supporting document uploaded",
              reasonFor: "Reason for revision",
              comment: "Comment (Optional)",
              useButton: "Use this reason",
              requestRevisionIntro: "Select a revision reason and explain why the change is needed.",
              responseProvided: "Response provided",
              whyRevisionNeeded: "Why this revision is needed",
              explanationToApplicant: "Explanation to applicant (optional)",
              explanationToApplicantHelper: "Explain to the applicant why you're requesting this revision.",
              explanationForInformationHelper: "Explain to the applicant why you're requesting this information.",
              nameRequestedInformation: "Name the requested information",
              nameRequestedInformationHelper:
                "Use a clear name, like 'Site plan' or 'Letter of assurance.' Request only one piece of information at a time.",
              uploadReferenceDocument: "Upload a reference document (optional)",
              submitterRevisionTitle: "Revise your response before re-applying",
              fieldLabel: "Field",
              explanationFromAuthority: "Explanation from building authority",
              notProvided: "Not provided",
              submitterInformationTitle: "Provide additional information before re-applying",
              ...
              emptySend: "Add at least one request before sending.",
              confirmRevisionTitle: "Confirm revision request",
              noteToApplicant: "Note to applicant",
              backToPermitApplication: "Back to permit application",
              reviewAndSendTitle: "Review and send requests",
              reviewAndSendIntro:
                "The following requests will be sent to the submitter. They will receive an email notification and will be able to view and respond to each request.",
              addMessageForSubmitter: "Add a message for the submitter",
              messageOptional: "Message (optional)",
              messageHelper: "Add context or next steps that apply to the requests overall.",
              requestsCount: "Requests ({{count}})",
              revisionsCount: "Revisions ({{count}})",
              supportingInformationCount: "Supporting information ({{count}})",
              needsOtherApplications: "Does this project need any other permit applications?",
              needsOtherApplicationsHelper: "If yes, you'll choose the permit applications to add on the next screen.",
              backToApplication: "Back to application",
              reviewAndSubmitTitle: "Review and submit revised application",
              reviewAndSubmitIntro: "Once submitted, the building authority will review your updated application.",
              addMessageForReviewer: "Add a message for the reviewer",
              resubmitMessageHelper: "Add any general context or notes about the changes you made.",
              requestProgress: "Request progress",
              revisionsProgress: "Revisions ({{addressed}} of {{count}} addressed)",
              supportingInformationProgress: "Supporting information ({{addressed}} of {{count}} addressed)",
              addressedItem: "{{label}} (Addressed)",
              unaddressedRequestsTitle_one: "{{count}} request has not been addressed",
              unaddressedRequestsTitle_other: "{{count}} requests have not been addressed",
              unaddressedRequestsBody:
                "You can still submit your application, but these requests will remain outstanding:",
              unaddressedRequestsHint:
                "If you're leaving a request unaddressed, explain why in the message to the reviewer above.",
              additionalChanges: "Additional changes",
              viewingSubmission: "You are viewing the submission from {{viewedAt}}.",
              revisedBySubmitterTitle: "This application has been revised by the submitter",
              revisedBySubmitterBody:
                "You requested revisions or additional information on {{requestedAt}}. The submitter resubmitted this application on {{resubmittedAt}}.",
              revisedBySubmitterResubmittedBody: "The submitter resubmitted this application on {{resubmittedAt}}.",
              summaryOfRevisions: "Summary of revisions",
              messageFromSubmitter: "Message from submitter",
              requestedRevisions: "Requested revisions",
              ...
              revisionsEmpty: "No revisions requested.",
              supportingInformationSection: "Supporting information",
              permitApplicationSection: "Permit application",
              addSupportingInformation: "Request supporting information",
              addPermitApplication: "Add a permit application",
              supportingInformationTitle: "Requested file(s)",
              supportingInformationDescription: "Reason",
              supportingInformationFiles: "Upload reference files",
              supportingInformationEmpty: "No supporting information requested.",
              permitApplicationEmpty: "No additional permit applications requested yet.",
              permitApplicationSearch: "Search permit types",
              permitApplicationComment: "Comment (optional)",
              reviewerComments: "Reviewer comments",
              reviewerCommentsEmpty: "No overall comments were included with these requests.",
        ...
        questionBank: {
          ...
          fieldDescriptions: {
            description: "Provide some context for admins for this question.",
          ...
          modals: {
            ...
            questionSetupTitle: "Question setup",
            ...
            usage: {
              ...
              noBlocks: "This question is not currently used in any requirement blocks.",
              addToRequirementBlock: "Add to requirement block",
              noTemplates: "Not currently used in any permit templates.",
            },
            defaultHelpText: "Default help text",
            defaultHelpTextLabel: "Default help text",
            addDefaultHelpText: "Add default help text",
            editDefaultHelpText: "Edit default help text",
            defaultInstructions: "Default instructions",
            defaultInstructionsLabel: "Default instructions",
            addDefaultInstructions: "Add default instructions",
            editDefaultInstructions: "Edit default instructions",
            defaultContentInfo: "About shared defaults",
            defaultContentExplanation:
              "This is the default for reused questions. It can be customized within an individual requirement block without detaching the question.",
            archived: "Archived",
            propagationWarning:
              "Changes to this shared question and its defaults will apply to unpublished templates that use it. Block-specific help text and instruction customizations will not be replaced.",
            propagationConfirm: {
              title: "Are you sure?",
              body: "This question is connected to one or more requirement blocks. Saved changes cannot be undone and will apply to unpublished templates that use this question, except where help text or instructions have been customized for a block.",
            },
            create: {
              triggerButton: "Create new question",
              title: "New Question",
              incomplete: "Please add an internal name and a field with a label before saving.",
              newSharedQuestion: "Create new shared question",
            },
            edit: {
              title: "Edit Question",
              options: "Options",
        ...
        requirementsLibrary: {
          ...
          modals: {
            ...
            clickToWriteNickname: "Click to write custom name",
            blockSetupTitle: "Block setup",
            internalUse: "For internal use only",
            configureFields: "Configure the form fields below that submitters will see:",
            noFormFieldsAdded: "No question or form field have been added yet.",
            ...
            usingSharedDefault: "Using the shared question default",
            customizedForBlock: "Customized for this requirement block",
            useSharedDefault: "Use shared default",
            addCustomHelpText: "Add custom help text",
            addCustomInstructions: "Add custom instructions",
            customizeHelpText: "Customize help text for this block",
            customizeInstructions: "Customize instructions for this block",
            ...
            conditionalSetup: {
              ...
              operators: {
                ...
                greaterThanOrEqual: "Greater or equal to",
                lessThan: "Less than",
                lessThanOrEqual: "Less than or equal to",
                isDateEqual: "Equals",
                isNotDateEqual: "Not equal to",
                dateGreaterThan: "After",
                dateGreaterThanOrEqual: "On or after",
                dateLessThan: "Before",
                dateLessThanOrEqual: "On or before",
                isEmpty: "Is empty",
        ...
        stepCode: {
          ...
          index: {
            title: "Step Codes",
            createReportTitle: "Create a Step Codes compliance report",
            ...
            lookupTitle: "Look up Step Codes requirements",
          ...
          shareReport: {
            ...
            confirmTitle: "Email this report?",
            confirmBody:
              "This emails the Step Code report to the jurisdiction. Send it only once, as each share sends another email.",
            confirm: "Send email",
          },
          projectInformation: {
            ...
            nonPreConstructionStageWarning:
              "Under typical circumstances, the pre-construction checklist should be selected for new construction permit applications.",
          ...
          part3: {
            ...
            locationDetails: {
              ...
              climateZone: {
                label: "Climate zone",
                hint: "Determined automatically from the heating degree days value above.",
                pending: "Enter heating degree days above to determine the climate zone.",
            ...
            stepCodePerformanceRequirements: {
              ...
              stepCodeRequirement: {
                ...
                energyStepRequired: {
                  ...
                  error: "Select Energy Step Code required",
                },
                source: {
            ...
            metrics: {
              ...
              teui: { label: "TEUI", units: "kWh/m²/year" },
              tedi: { label: "TEDI", units: "kWh/m²/year" },
              ghgi: { label: "GHGI", units: "kgCO₂/m²/year" },
            },
            requirementsSummary: {
          ...
          part9: {
            ...
            sidebar: {
              ...
              energyStepCompliance: "Energy Step Code compliance",
              zeroCarbonCompliance: "Zero Carbon Step Code compliance",
              results: "Results",
              review: "Review",
              report: "Report",
            },
            ...
            report: {
              ...
              stale: "This report is out of date. Regenerating will create a new report you can download and share.",
              missing: "No report has been generated yet. Generate a report to download or share it.",
            },
          },
          ...
          goToStepCodes: "Go to Step Code search",
          subNav: {
            title: "Energy and Zero Carbon Step Codes compliance",
            projectInfo: "Project Step Codes information",
          },
          ...
          import: {
            title: "Import",
            lockedUntilH2k: "Upload an H2K file before continuing to the compliance sections.",
        ...
        home: {
          ...
          projectReadinessTools: {
            ...
            lookUpStepCodesRequirementsForYourProject: "Look up Step Codes requirements",
            lookUpToolProjectDescription:
              "Enter an address to find the Energy and Zero Carbon Step Code requirements for your project",
            checkIfYourProjectMeetsBCsStepCodesRequirements: "Create a Step Codes compliance report",
            ...
            lookUpStepCodesRequirementsForYourProjectScreen: {
              title: "Look up Step Codes requirements",
              jurisdiction: "Jurisdiction",
              ...
              checkIfYourProjectMeetsBCsStepCodesRequirements: "Create a Step Codes compliance report",
              stepCodeRequirementsFor: "Step Codes Requirements for",
              ...
              locationNameColumnHeader: "Location name",
              ...
              requirementsLastUpdated: "Requirements last updated: {{date}}",
              requirementsLastUpdatedNotAvailable: "Not available",
              part3BuildingsAreGenerally: "Part 3 buildings are generally:",
              part9BuildingsAreGenerally: "Part 9 buildings are generally:",
              smallSimpleBuildingsLinkPrefix: "If your building falls under Part 9 of the BC Building Code,",
              largeComplexBuildingsLinkPrefix: "If your building falls under Part 3 of the BC Building Code,",
              checkStepCodesRequirementsInThisCommunity:
                "check the Step Codes requirements and heating degree day values in this community",
            },
          },
          joinTheBuildingPermitHub: {
            ...
            learnMore: {
              ...
              infoDocuments:
                "You can also browse <infoDocumentsLink>information sheets</infoDocumentsLink> for one-page summaries about Building Permit Hub.",
          ...
          configurationManagement: {
            ...
            stepCodeRequirements: {
              ...
              climateZones: {
                ...
                validation: {
                  ...
                  locationNameUnique: "Location names must be unique",
                  hddRequired: "HDD is required",
              ...
              occupancyDetail: {
                ...
                pathwayDescriptionLabel: "Description",
                pathwayDescriptionPlaceholder: "e.g. Use this if the building is over 6 storeys",
              ...
              stepRequired: {
                ...
                description: {
                  title: "Description",
                  placeholder: "e.g. Use this if the building is over 6 storeys",
                },
              },
            },
            globalFeatureAccess: {
            ...
            featureAccess: {
              ...
              submissionInbox: "Submissions setup",
              ...
              projectMeetingsDescription:
                "When this feature is turned on, users can submit project meeting requests. The email addresses set in this section will receive submitted requests.",
              acceptProjectMeetings: "Project meetings",
              turnOnProjectMeetings: "Turn on",
              turnOffProjectMeetings: "Turn off",
              sendRequestsFor: "Send requests for",
              projectMeetingsNotificationRecipients: "Project meeting notification recipients",
              projectMeetingsNotificationRecipientsDescription:
              ...
              propertyInformationRequestsDescription:
                "When turned on, users can request property information as part of a project meeting request. Property information requests are emailed separately from a project meeting request.",
              turnOffPropertyInformationRequests: "Disable property information requests",
              propertyInformation: "Property information",
              propertyInformationNotificationRecipients: "Property information request notification recipients",
              propertyInformationNotificationRecipientsDescription:
                "Specify email addresses that should receive property information requests.",
              propertyInformationEmailLabel: "to recipient email(s)",
              propertyInformationAddEmail: "Add another email",
              propertyInformationConfirmationRequired: "Action required: please click link in verification email",
        ...
        infoDocuments: {
          index: {
            ...
            documentList: "Information sheets",
            emptyTitle: "No information sheets yet",
            emptyBody:
              "Information sheets will appear here once they are published. Check back soon, or contact us if you are looking for something specific.",
            errorTitle: "We could not load the documents",
            errorBody:
              "Something went wrong on our end. Try again. If the problem continues, contact us and we will help you find the document you need.",
            retry: "Try again",
            ...
            allTopics: "All",
            showingCount: "Showing {{shown}} of {{total}} documents",
          },
          management: {
            title: "Information sheets",
        ...
        helpVideos: {
          ...
          management: {
            ...
            fields: {
              ...
              description: "Description",
              shortDescription: "Short description",
              shortDescriptionHelp: "Appears on the video selector card. Maximum 256 characters.",
              about: "About this video",
              aboutHelp: "Appears on the video page. Type as a bulleted list.",
              section: "Section",
              published: "Published",
              publishedHelp: "When checked, the video is made public to all users.",
            ...
            videos: {
              ...
              deleteBody: "Are you sure you want to delete this video?",
            },
            sections: {
              ...
              deleteBody: "Are you sure you want to remove this section?",
              dragHandle: "Drag to reorder section",
              dragVideoHandle: "Drag to reorder video",
              videosTitle: "Videos in this section",
        ...
        projectReadinessTools: {
          ...
          prepareYourApplication: "Prepare your application package for submission",
          letterOfAssuranceLink: "Create your Letters of Assurance",
          meetStepCodeLink: "Create a Step Codes compliance report",
          digitalSealValidator: {
            ...
            digitalSignaturesDetected: "Digital seal found",
            dragAndDrop: "Drag and drop files here, or",
            requirement1: "PDF format only",
          ...
          meetStepCodeDescription:
            "Generate a report that details a project's compliance with BC's Energy Step Code and Zero Carbon Step Code requirements",
          preCheckDrawingsLink: "Pre-check your drawings for compliance with the BC Building Code",
          ...
          checkStepCodeRequirementsScreen: {
            pageHeading: "Create a Step Codes compliance report",
        ...
        user: {
          ...
          notifications: {
            ...
            reviewStarted: "Application review started by jurisdiction",
        ...
        requirementTemplate: {
          ...
          edit: {
            ...
            blockConditional: {
              addConditional: "Add block conditional",
              editConditional: "Edit block conditional",
              removeConditional: "Remove",
              showBlock: "Show this block",
              hideBlock: "Hide this block",
              ...
              selectOperator: "Select comparison...",
              selectValue: "Select a value...",
              hasFile: "Has file",
              noFile: "No file",
              conditionalActive:
                'Conditional: {{effect}} when "{{blockName}}" → "{{fieldLabel}}" {{operatorLabel}} {{value}}',
            },
            stepCodeWarnings: {
            ...
            earlyAccess: "Publish early access",
            ...
            configErrors: {
              title: "Linked configuration errors ({{count}})",
              instructions: "Fix these issues before creating or promoting a version:",
              blockError: "{{blockName}}: {{message}}",
              fieldError: "{{blockName}} — {{fieldName}}: {{message}}",
              warningIcon: "Warning",
              toggle: "Toggle configuration errors",
            },
            diffBox: {
          ...
          versionSidebar: {
            ...
            noDeprecatedVersion: "No deprecated versions",
            listTitles: {
              published: "Published",
            ...
            downloadsDescription: "Download files generated from the published version of this template.",
          },
          export: {
        ...
        digitalBuildingPermits: {
          ...
          edit: {
            requirementBlockSidebar: {
              ...
              noResourcesYet: "When you add resources, they will appear here.",
        ...
        siteConfiguration: {
          ...
          infoDocuments: {
            title: "Information sheets",
            description: "Manage public information sheets",
          },
          templateCategories: {
            ...
            deleteBody: "Templates in this category will move to Uncategorized.",
        ...
        reporting: {
          ...
          stepCodeSummary: {
            ...
            description: "A summary of Step Codes requirements by jurisdictions",
          ...
          shell: {
            chartHeading: "Chart",
            tableHeading: "Data",
            notesTitle: "About these figures",
            caveatsTitle: "Caveats",
            notMeasuredTitle: "Not measured",
            emptyTitle: "No data for this selection",
            emptyBody: "Nothing was recorded for the current range. This is a finding, not a failed load.",
            emptyTable: "No rows",
            approximate: "(approximate)",
            unavailableTitle: "This report could not be loaded",
            loading: "Loading report",
            tables: {
              templates: "By template",
              versions: "By template version",
              by_month: "By month",
              by_status: "By status",
              by_jurisdiction: "By jurisdiction",
              outcomes: "Compliance outcomes",
              energy_step: "Energy step",
              zero_carbon_step: "Zero carbon step",
              combined: "By template",
              published_never_used: "Published, never used",
              new_by_month: "New accounts by month",
              cumulative_by_month: "Cumulative accounts by month",
              jurisdictions: "By jurisdiction",
            ...
            charts: {
              ...
              energy_step: "Energy step",
              zero_carbon_step: "Zero carbon step",
              enabled_by_quarter: "First enabled by quarter",
              submission_cohorts: "First submission by quarter",
              combined: "By template",
              new_by_month: "New accounts by month",
              submitter_mix: "Submitter mix",
              stale_drafts: "Stale drafts",
              bytes_added_by_month: "Bytes added by month",
            },
          },
          controls: {
            range: "Time range",
            ...
            refreshFailedBody: "Previous figures are still shown. Try again.",
            ranges: {
        ...
        externalApiKey: {
          ...
          fieldLabels: {
            ...
            sandbox: "Permit template access",
          },
          apiVersionHint: "The API version cannot be changed after this key is created.",
          apiVersion: {
            v1: "V1 — Legacy read-only API",
            v2: "V2 — Bidirectional status API",
          },
        ...
        site: {
          ...
          navMenu: {
            ...
            projectReadiness: {
              all: {
                label: "Prepare and check your project documents",
              ...
              bcBuildingCode: {
                label: "Pre-check your drawings for compliance with the BC Building Code",
            ...
            about: {
              ...
              forLocalGovernments: {
                label: "Join Building Permit Hub",
          ...
          contact: "Contact us",
          videos: "Videos",
          infoDocuments: "Information sheets",
          ...
          help: "Help",
          aboutTitle: "About",
          aboutGovBcCa: "About gov.bc.ca",
          moreInfo: "More info",
          multiLanguageAccessibility: "We can help in over 220 languages and through other accessible options.",
          callEmailOrTextUs: "Call, email or text us",
          findAServiceCentre: "find a service centre",
          ...
          breadcrumb: {
            ...
            documents: "Documents",
            meetings: "Meetings",
            requestProjectMeeting: "Request a project meeting",
            projectMeetings: "Project meetings",
            projectInformation: "Project information",
            relationship: "Relationship to site",
            authorizationDocuments: "Authorization documents",
            contactDetails: "Contact details",
            discussion: "What you'd like to discuss",
            propertyInformation: "Property information",
            ...
            standardizationPreview: "Standard permit application materials",
            preCheck: "Pre-check your drawings for compliance with the BC Building Code",
            overheatingCodes: "Overheating",
            projects: "Projects",
            checkDigitalSeals: "Check digital seals",
            codeCompliance: "Code compliance",
            permitClassifications: "Permit classifications",
            overheating: "Overheating",
            createAStepCodesComplianceReport: "Create a Step Codes compliance report",
            latest: "Latest",
            profile: "Profile",
            ...
            stepCodes: "Step Codes",
            digitalBuildingPermits: "Configure digital applications",
            contact: "Contact us",
            ...
            submissionInboxSetup: "Submissions setup",
            energyStep: "Step Codes requirements",
            ...
            submissionsInboxSetup: "Submissions setup",
            confirmed: "E-mail confirmed",
            about: "About Building Permit Hub",
            ...
            jurisdictionVolume: "Permit volume and concentration",
            templateUsage: "Template usage",
            templateStall: "Template stall and withdrawal",
            accounts: "Accounts",
            submitterAdoption: "Submitter adoption",
            draftCompletion: "Draft completion",
            reviewProcess: "Review process",
            platformHealth: "Platform health",
            storageFootprint: "Storage footprint and forecast",
            ...
            lookUpStepCodesRequirements: "Look up Step Codes requirements",
            onboardingChecklistPageForLgAdopting: "Join Building Permit Hub",
            stepCodeRequirements: "Step Codes requirements",
            start: "Start",
            buildingCategories: "Building categories",
            resources: "Resources",
        ...
        releaseNote: {
          ...
          viewing: {
            ...
            filterByType: "Filter by release type",
            allTypes: "All release types",
          },
          ...
          types: {
            ...
            content: "Applications and permits",
          },
          form: {
            newTitle: "Create release note",
            ...
            nameHint: "A short, plain-language title for this content update.",
            versionInvalidSemver: "Version must be a valid semantic version",
            releaseDate: "Release date",
            releaseNotesUrl: "Release notes URL",
            content: "Content",
            issues: "Issues",
            addIssues: "Add Issues",
            removeIssues: "Remove Issues",
            saveDraft: "Save draft & close",
            publish: "Publish",
            update: "Update",
            publishConfirmation: {
            ...
            updateConfirmation: {
              ...
              body: "Are you sure you want to update this published release note? Changes will be visible to users immediately.",
            },
            viewPublishedNote: "View published note",
            cancel: "Cancel",
          },
          columns: {
