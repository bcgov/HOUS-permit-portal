    ...
    en: {
      translation: {
        ...
        site: {
          ...
          privacyPolicyEffectiveDate: "Effective Date: [Insert Date]",
          privacyPolicyLastUpdated: "Last Updated: [Insert Date]",
          privacyPolicyAppliesTo: "Applies To: The Building Permit Hub",
